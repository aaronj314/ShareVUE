//
//  ProjectVideoListViewController.m
//  ShareVUE
//
...
@implementation ProjectVideoListViewController
@synthesize videos;
@synthesize project;
...
-(id)initWithStyle:(UITableViewStyle)style {
	if ((self = [super initWithStyle:style])) {
		self.title = @"Project Videos";
		
		playlistName = [[UITextField alloc] initWithFrame:CGRectMake(5, 5, 755, 30)];
...
- (void)loadView {
	[super loadView];
	playlistName.text = project.name;
}
